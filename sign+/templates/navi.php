...
global $i;
?>
<div class="navbar navbar-default test111" role="navigation">
  ...
  <div class="navbar-collapse col-xs-12 col-md-10 collapse" id="bs-example-navbar-collapse-1">
    ...
    <ul class="nav navbar-nav">
      <li class="dropdown" class="active">
        ...
        <ul class="dropdown-menu">
		  ...
		  <li><a href="http://www.stus8.com" target="_blank">模板制作：aa 丶</a></li>
          <?php doAction('navi_5'); ?>
        </ul>
      </li>
  	</ul>
            ...
            <ul class="nav bs-sidenav">    
              ...
              <?php } else { ?>
				...
				<style>
					...
					.login-aa{display:none;}
					#uyan_frame{display:none !important;}
					.login-aa2{
						width: 83.33333333%;
...
<div class="col-md-9 login-aa2" role="main">