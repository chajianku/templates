...
<div class="container">
  <!-- NAVI -->
  <div class="card">
    <div class="card-image" style="height:50px;padding:0px;background-color:#FF9900;">
      <span style="padding:10px;" class="card-title">百度账号管理</span>
    </div>
    <ul class="tabs" id="PageTab">
      <li class="tab col s4"><a href="#adminid" data-toggle="tab" onclick="$('#newid2').css('display','none');$('#newid').css('display','none');$('#adminid').css('display','');">管理账号</a></li>
      <?php if (option::get('bduss_num') != '-1') { ?><li class="tab col s4"><a href="#newid" data-toggle="tab" onclick="$('#newid').css('display','');$('#adminid').css('display','none');$('#newid2').css('display','none');">自动绑定</a></li>
        <li class="tab col s4"><a href="#newid2" data-toggle="tab" onclick="$('#newid2').css('display','');$('#adminid').css('display','none');$('#newid').css('display','none');">手动绑定</a></li><?php } ?>
      </ul>
      <br/>
      <!-- END NAVI -->

      <!-- PAGE1: ADMINID-->
      <div class="tab-pane fade in active" id="adminid" style="padding:10px;">
        <a name="#adminid"></a>
        <?php if (option::get('bduss_num') == '-1' && ROLE != 'admin') { ?>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                 ...
                 foreach ($i['user']['bduss'] as $key => $value) {
                  echo '<tr><td style="font-size:18px;padding-top:20px;">'.$key.'</td>';
                  if (option::get('baidu_name') == '1') {
                    echo '<td style="font-size:18px;padding-top:20px;">'.$i['user']['baidu'][$key].'</td>';
                  }
                  echo '<td><input type="text" class="validate" readonly value="'.$value.'"></td><td><a class="btn btn-default" href="setting.php?mod=baiduid&del='.$key.'">解绑</a></td></tr>';
                }
                ?>
              </tbody>
            </table>
          ...
          <!-- PAGE2: NEWID -->
          <div class="tab-pane fade" id="newid" style="display:none;padding:10px;padding-bottom:10px;">
            ...
            <div id="addbdid_prog" style="display:none;padding:20px;">
            ...
            <form method="post" id="addbdid_form" onsubmit="addbdid_getcode();return false;">
              <div class="input-group">
                ...
                <input type="text" style="padding-left:20px;" class="form-control" id="bd_name" placeholder="你的百度账户名，建议填写邮箱" required>
              </div>
              <br/>

              <div class="input-group">
                <span class="input-group-addon">百度密码</span>
                <input type="password" style="padding-left:20px;" class="form-control" id="bd_pw" placeholder="你的百度账号密码" required>
              </div>
          ...
          <!-- PAGE3: NEWID2 -->
          <div class="tab-pane fade" id="newid2" style="display:none;padding:10px;">
