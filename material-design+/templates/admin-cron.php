...
<div class="container">
<div class="card">
<div class="card-image pink" style="height:50px;padding:0px;">
<span style="padding:10px;" class="card-title">计划任务</span>
</div>
...
<br/><button type="submit" class="btn btn-primary blue">提交更改</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
foreach ($i['cron'] as $cs) {
	...
	$status .= '<br/><label for="'.$cs['orde'].'">运行顺序 </label> <input required style="width:30%" type="number" id="'.$cs['orde'].'" name="order['.$cs['name'].']" value="'.$cs['orde'].'">';
...
?>
<div class="card blue-grey darken-1"><div class="card-content white-text">当前共有 <?php echo $crount['ffffff'] ?> 个计划任务，您需要添加根目录下 do.php 到您主机的计划任务后，下面的任务才能被执行。<br/><br/>
<div class="card-action" style="padding:0px;padding-top:10px;">
<a href="index.php?mod=admin:cron&add">添加新计划任务</a> <a href="do.php?pw=<?php echo option::get('cron_pw') ?>">运行全部计划任务</a>
</div></div></div>
...
<input type="submit" class="btn btn-primary blue" value="提交更改">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-info yellow" onclick="location = 'index.php?mod=admin:cron&add'">添加计划任务</button>
</form>
<br/><?php } ?>
</div></div></div>
