...
<span style="padding:10px;" class="card-title">高级功能</span>
</div>
<div class="card-content">
<div id="comsys"></div>
<!--Part 1 Primary-->
<style type="text/css">.btn-primary,.btn-warning{width:200px!important;}</style>
<input type="button" onclick="location = '<?php echo SYSTEM_URL ?>setting.php?mod=admin:tools&setting=optim'" class="btn btn-primary green" value="优化所有的数据表" style="width:170px">&nbsp;&nbsp;&nbsp;&nbsp;可清除所有数据表的多余数据

<br/><br/><input type="button" onclick="location = '<?php echo SYSTEM_URL ?>setting.php?mod=admin:tools&setting=reftable'" class="btn btn-primary green" value="扫描空闲的签到表" style="width:170px">&nbsp;&nbsp;&nbsp;&nbsp;扫描空闲的签到数据表，用户注册时系统会自动扫描

<br/><br/><input type="button" onclick="location = '<?php echo SYSTEM_URL ?>setting.php?mod=admin:tools&setting=fixdoing'" class="btn btn-primary blue" value="修复计划任务状态" style="width:170px">&nbsp;&nbsp;&nbsp;&nbsp;可解决运行计划任务始终提示已经有一个计划任务正在运行中的问题

<br/><br/><input type="button" onclick="location = '<?php echo SYSTEM_URL ?>setting.php?mod=admin:tools&setting=cron_sign_again'" class="btn btn-primary blue" value="清空签到重试次数统计" style="width:170px">&nbsp;&nbsp;&nbsp;&nbsp;[ 当前重试次数：<?php $sign_again = unserialize(option::get('cron_sign_again')); echo  $sign_again_num = empty($sign_again['num']) ? 0 : $sign_again['num'] ?> ] 本操作将清除目前的签到重试次数统计

<br/><br/><input type="button" data-toggle="modal" data-target="#RunSql" class="btn btn-primary orange" value="运行 SQL 语句" style="width:170px">

<br/><br/><input type="button" data-toggle="modal" data-target="#BackupTable" class="btn btn-primary orange" value="导出数据库" style="width:170px">&nbsp;&nbsp;&nbsp;&nbsp;导出数据库备份
<!--
...
<br/><br/>
<!--Part 2 Warning-->
<br/><br/><input type="button" data-toggle="modal" data-target="#TruncateTableLabel" class="btn btn-warning red" value="清空指定数据表" style="width:170px">&nbsp;&nbsp;&nbsp;&nbsp;请慎用此功能，一般用于删除无用的分表

<br/><br/><input type="button" data-toggle="modal" data-target="#RemoveTable" class="btn btn-warning red" value="删除指定数据表" style="width:170px">&nbsp;&nbsp;&nbsp;&nbsp;请慎用此功能，一般用于删除无用的分表
...
<button type="submit" class="btn btn-primary blue" id="runsql_button">提交并运行</button>
</div>
</form>
</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
...
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
<button type="submit" class="btn btn-primary blue" id="backup_button">开始导出</button>
</div>
</form>
</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
...
<div class="modal-footer">
<button type="button" class="btn btn-default blug" data-dismiss="modal">取消</button>
<button type="submit" class="btn btn-danger red" id="remtab_button">提交更改</button>
</div>
</form>
</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
...
<div class="modal-footer">
<button type="button" class="btn btn-default blue" data-dismiss="modal">取消</button>
<button type="submit" class="btn btn-danger red" id="truntab_button">提交更改</button>
</div>
</form>
</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
